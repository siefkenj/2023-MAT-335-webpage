...
%%%
\begin{document}
	\setheader{MAT335}{Homework 0}{Due: 11:59pm January 15}{}{}{}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			\item Clone the {\tt homework0-intro.ipynb} into your syzygy account by clicking the link:
				...
				clone the notebook from \url{https://github.com/siefkenj/2023-MAT-335-webpage/tree/main/homework}
				...
				\url{https://utoronto.syzygy.ca/jupyter/user-redirect/git-pull?repo=https://github.com/siefkenj/2023-MAT-335-webpage&subPath=homework/homework0-exercises.ipynb}

				{\textbf{Note:}} {The \texttt{homework0-exercises.ipynb} file has \emph{stubs} for each of
				the programming tasks. This is, there are pre-defined functions in the notebook with the correct
