...
\addcontentsline{toc}{chapter}{Lessons}
	...
	\begin{parts}
		...
		\item Let $\mu$ be defined by $\mu(A)=\begin{cases}1&\text{ if }1/3\in A\\0&\text{ otherwise}\end{cases}$.
				Is $\mu$ a probability measure? Is $\mu$ invariant?
		\item Let $\mu$ be defined by $\mu(A)=\begin{cases}1&\text{ if }1/3\in A\text{ or }2/3\in A\\0&\text{ otherwise}\end{cases}$.
				Is $\mu$ a probability measure? Is $\mu$ invariant?
